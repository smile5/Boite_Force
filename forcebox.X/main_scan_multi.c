...
void main(void) {
    ...
    while(1)
    {
        ...
        { // On a recu qque chose
          ...
          if( (RC1REG=='1') || (RC1REG=='2') || (RC1REG=='3') || (RC1REG=='4') || (RC1REG=='5') ||(RC1REG=='6')  )  
          { // on a change de nbre de module
          ...
          if( RC1REG== 'T')
          { // on demande un tarage ?
            // voir si on peut faire directement dans les MCP ou juste en software ?  
          }
        }
        ...
        switch (nbr_module) {
            case 6:
                for (i = 0; i < 4; i++)
                {
                    ...
                    {
                        case 0:
                            conv_xg[0] = mcp356x_result32_channel(6);
                            break;
                        case 1:
                            conv_xg[1] = mcp356x_result32_channel(6);
                            break;
                        case 2:
                            conv_xg[2] = mcp356x_result32_channel(6);
                            break;
                        case 3:
                            conv_xg[3] = mcp356x_result32_channel(6);
                            break;
                    }
                }
                for(i=0;i<4;i++)
                {   
                    UART_write('?');
                    UART_write('6');
                    UART_write(conv_xg[i].voie);
                    UART_write_long(conv_xg[i].result);
                    UART_write('!');
                }
            case 5:
                for (i = 0; i < 4; i++)
                {
                    ...
                    {
                        case 0:
                            conv_xg[0] = mcp356x_result32_channel(5);
                            break;
                        case 1:
                            conv_xg[1] = mcp356x_result32_channel(5);
                            break;
                        case 2:
                            conv_xg[2] = mcp356x_result32_channel(5);
                            break;
                        case 3:
                            conv_xg[3] = mcp356x_result32_channel(5);
                            break;
                    }
                }
                for(i=0;i<4;i++)
            ...
            case 4:
                for (i = 0; i < 4; i++)
                {
                    ...
                    {
                        case 0:
                            conv_xg[0] = mcp356x_result32_channel(4);
                            break;
                        case 1:
                            conv_xg[1] = mcp356x_result32_channel(4);
                            break;
                        case 2:
                            conv_xg[2] = mcp356x_result32_channel(4);
                            break;
                        case 3:
                            conv_xg[3] = mcp356x_result32_channel(4);
                            break;
                    }
                }
                for(i=0;i<4;i++)
            ...
            case 3:
                for (i = 0; i < 4; i++)
                {
                    ...
                    {
                        case 0:
                            conv_xg[0] = mcp356x_result32_channel(3);
                            break;
                        case 1:
                            conv_xg[1] = mcp356x_result32_channel(3);
                            break;
                        case 2:
                            conv_xg[2] = mcp356x_result32_channel(3);
                            break;
                        case 3:
                            conv_xg[3] = mcp356x_result32_channel(3);
                            break;
                    }
                }
                for(i=0;i<4;i++)
            ...
            case 2:
                for (i = 0; i < 4; i++)
                {
                    ...
                    {
                        case 0:
                            conv_xg[0] = mcp356x_result32_channel(2);
                            break;
                        case 1:
                            conv_xg[1] = mcp356x_result32_channel(2);
                            break;
                        case 2:
                            conv_xg[2] = mcp356x_result32_channel(2);
                            break;
                        case 3:
                            conv_xg[3] = mcp356x_result32_channel(2);
                            break;
                    }
                }
                for(i=0;i<4;i++)
            ...
            default: // on traite comme un seul module
                for (i = 0; i < 5; i++)
                {
                    ...
                    {
                        case 0:
                            conv_xg[0] = mcp356x_result32_channel(1);
                            break;
                        case 1:
                            conv_xg[1] = mcp356x_result32_channel(1);
                            break;
                        case 2:
                            conv_xg[2] = mcp356x_result32_channel(1);
                            break;
                        case 3:
                            conv_xg[3] = mcp356x_result32_channel(1);
                            break;
                        case 4:
                            conv_xg[4] = mcp356x_result32_channel(1);
                            break;
                    }
                }
                //__delay_ms(100);
