    ...
    ui(new Ui::MainWindow)
{
 ...
 //   settings->hide();
    ...
    // ui->tableWidget_1->setRowCount(1);
     ui->tableWidget_1->setColumnCount(1);
     ui->tableWidget_1->setHorizontalHeaderLabels({"Valeur (N)"});
     ui->tableWidget_1->horizontalHeader()->setSectionResizeMode(QHeaderView::Stretch);
     ui->tableWidget_2->setColumnCount(1);
     ui->tableWidget_2->setHorizontalHeaderLabels({"Valeur (N)"});
     ui->tableWidget_2->horizontalHeader()->setSectionResizeMode(QHeaderView::Stretch);
     ui->tableWidget_3->setColumnCount(1);
     ui->tableWidget_3->setHorizontalHeaderLabels({"Valeur (N)"});
     ui->tableWidget_3->horizontalHeader()->setSectionResizeMode(QHeaderView::Stretch);
     ui->tableWidget_4->setColumnCount(1);
     ui->tableWidget_4->setHorizontalHeaderLabels({"Valeur (N)"});
...
void MainWindow::on_add_tableau_clicked()
{
    // ui->tableWidget_1->insertRow(0);
    // ui->tableWidget_1->indexAt(QPoint(0,0)).data()=ui->valeur_V1->text();
     ui->tableWidget_1->insertRow(0);
     ui->tableWidget_1->setItem(0,0,new QTableWidgetItem(ui->valeur_V1->text()));
     ui->tableWidget_2->insertRow(0);
     ui->tableWidget_2->setItem(0,0,new QTableWidgetItem(ui->valeur_V2->text()));
     ui->tableWidget_3->insertRow(0);
     ui->tableWidget_3->setItem(0,0,new QTableWidgetItem(ui->valeur_V3->text()));
     ui->tableWidget_4->insertRow(0);
     ui->tableWidget_4->setItem(0,0,new QTableWidgetItem(ui->valeur_V4->text()));
     //ui->tableWidget_1->
}
